...
class Loss():
    ...
    def loss_result_from_all(self, object, sum_loss_from_all, count_in_team):
        return sum_loss_from_all/count_in_team + self.calc_loss_of_distance(object) if count_in_team != 0 else 0
